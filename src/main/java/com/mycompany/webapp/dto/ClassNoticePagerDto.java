...
public class ClassNoticePagerDto {
	...
	private int startRowNo; 	//페이지의 시작행 번호
	private int endRowNo;		//페이지의 마지막행 번호
	private int class_no;
	
															//전체행수
	public ClassNoticePagerDto(int rowsPerPage, int pagesPerGroup, int totalRows, int pageNo) {
