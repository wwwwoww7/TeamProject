...
<section id="table_list" class="section-table cid-shflacCz1o" >
 <div class="container" >
	<div class="row" >
		<table class="table1 col-12"  style="border: 0px solid;" >
			<tr>
			...
			<c:forEach var="event" items="${all2}">
				<tr>
					...
					<td id="imgcol">
						<div class="m-3">
							<a href="<%=application.getContextPath()%>/event/eventDetail2?event_no=${event.event_no}">
								<img id="eventlistimg" src="<%=application.getContextPath()%>/event/event_imgDownload?event_img=${event.event_img}" width="400" height="240" />
							</a>
						</div>
					</td>
