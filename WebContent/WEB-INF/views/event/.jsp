    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1" color="yellow">EVENT DETAIL</h1>
                
                <p class="mbr-text pb-3 mbr-fonts-style display-5">
                    	이벤트 상세페이지 멘트...
                </p>
                <div class="mbr-section-btn"><a class="btn btn-md btn-success display-4" href="http://localhost:8080/teamproject/allClass">클래스 수강하러가기</a>
