...
<div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
	...
	<form action="communityWrite" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name">
		...
		<div class="dragArea row" style="margin: 5px">
			<div class="col-md-6 input-group">
				...
				<select id="class_nm_s" name="class_nm_s" style="width: 65%;">
					<c:forEach var="communityWrite" items="${communityWrite}">
						<option value="강의명1" selected>${communityWrite.comm_cate_nm}</option>
					</c:forEach>
				</select>
			</div>
			 <div class="col-md-6 input-group">
		...
		<!-- <div class="dragArea row" style="margin: 5px">
		 ...
		 <div class="dragArea row">
			...
			<div class="col-md-4">
				<a class="btn item-btn btn-success display-7 text-primary" style="margin: 5px;" href="javascript:communityWrite()" >글쓰기</a>
				...
				function communityWrite() {
					...
					$.ajax({
						url:"communityWrite",
						method:"post",
						data: {comm_title:comm_title, comm_content:comm_content, mid:mid},
